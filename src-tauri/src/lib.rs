...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_process_objects,
            commands::close_process_handle,
            commands::set_process_privilege,
            commands::set_process_window_enabled,
            ...
            commands::select_thread,
            commands::suspend_threads,
            commands::resume_threads,
            commands::terminate_threads,
            ...
            commands::pe_disassemble_preview_batch,
            commands::pe_save,
            commands::pe_close,
