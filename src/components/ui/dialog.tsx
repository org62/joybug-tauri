...
// forwardRef, not a plain function: Radix's DialogPortal wraps each child in a
// Slot that clones it with a ref, and on React 18 a function component can't
// receive one ("Function components cannot be given refs" on every open).
